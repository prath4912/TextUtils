...
<p  className="cbtn1" >
  <a className="btn btn-primary" id="ctb1" style={{visibility :"visible"}}  data-bs-toggle="collapse" onClick={cnum}  href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample">Ask Me <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-chat-right-fill" viewBox="0 0 16 16">
